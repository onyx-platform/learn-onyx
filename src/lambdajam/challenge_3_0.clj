  ...
  ([batch-size batch-timeout]
     [{:onyx/name :read-segments
      ...
      {:onyx/name :alternate-case
       :onyx/fn :lambdajam.challenge-3-0/alternate-case
       :onyx/type :function
       :onyx/batch-size batch-size
       :onyx/batch-timeout batch-timeout
      ...
      {:onyx/name :exclaim
       :onyx/fn :lambdajam.challenge-3-0/exclaim
       :onyx/type :function
       :onyx/batch-size batch-size
       :onyx/batch-timeout batch-timeout
...
(defn build-lifecycles []
  [{:lifecycle/task :read-segments
    :lifecycle/calls :lambdajam.challenge-3-0/reader-lifecycle
   ...
   {:lifecycle/task :write-segments
    :lifecycle/calls :lambdajam.challenge-3-0/writer-lifecycle
    :core.async/id (java.util.UUID/randomUUID)
