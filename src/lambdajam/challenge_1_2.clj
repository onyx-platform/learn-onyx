...
(defn build-catalog
  ...
  ([batch-size batch-timeout]
     [{:onyx/name :read-segments
      ...
      {:onyx/name :cube-n
       :onyx/fn :lambdajam.challenge-1-2/cube-n
       :onyx/type :function
       :onyx/batch-size batch-size
       :onyx/batch-timeout batch-timeout
      ...
      {:onyx/name :add-ten
       :onyx/fn :lambdajam.challenge-1-2/add-ten
       :onyx/type :function
       :onyx/batch-size batch-size
       :onyx/batch-timeout batch-timeout
      ...
      {:onyx/name :add-forty
       :onyx/fn :lambdajam.challenge-1-2/add-forty
       :onyx/type :function
       :onyx/batch-size batch-size
       :onyx/batch-timeout batch-timeout
      ...
      {:onyx/name :multiply-by-5
       :onyx/fn :lambdajam.challenge-1-2/multiply-by-5
       :onyx/type :function
       :onyx/batch-size batch-size
       :onyx/batch-timeout batch-timeout
...
(defn build-lifecycles []
  [{:lifecycle/task :read-segments
    :lifecycle/calls :lambdajam.challenge-1-2/reader-lifecycle
   ...
   {:lifecycle/task :write-segments
    :lifecycle/calls :lambdajam.challenge-1-2/writer-lifecycle
    :core.async/id (java.util.UUID/randomUUID)
