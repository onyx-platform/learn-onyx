...
(defn build-catalog
  ...
  ([batch-size batch-timeout]
     [;; The first catalog entry we'll look at is an :input
      ...
      ;; segment.
      {:onyx/name :times-two
       :onyx/fn :lambdajam.challenge-2-0/times-two
       :onyx/type :function
       :onyx/batch-size batch-size
       :onyx/batch-timeout batch-timeout
...
(defn build-lifecycles []
  [{:lifecycle/task :read-segments
    :lifecycle/calls :lambdajam.challenge-2-0/reader-lifecycle
   ...
   {:lifecycle/task :write-segments
    :lifecycle/calls :lambdajam.challenge-2-0/writer-lifecycle
    :core.async/id (java.util.UUID/randomUUID)
